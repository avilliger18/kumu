...
const ios = {
  ...
  card: PlatformColor("secondarySystemGroupedBackground") as unknown as string,
  fill: PlatformColor("systemGray6") as unknown as string,
  ...
  systemGray: PlatformColor("systemGray") as unknown as string,
};
